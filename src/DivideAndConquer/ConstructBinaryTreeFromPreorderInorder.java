...
public class ConstructBinaryTreeFromPreorderInorder {
    ...
    //做法: 在preorder上的顺序是root, 左边的子树的所有点, 右边的子树的所有点; 在inorder上的顺序是左子树所有点, 根节点, 右子树, 所以我们知道在inorder上,
    // 如果root是inorder[i]的话, 0到i-1就是他的左子树, i+1到inorder.length-1就是他的右子树, 所以我们就这么循环下去建立整个binary tree
